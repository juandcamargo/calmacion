...
export default function Auth() {
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", fontFamily: "'Circular Spotify Text', sans-serif" }} className="flex items-center justify-center p-6">
      <style>{`
      ...
      <div className="w-full" style={{ maxWidth: 380 }}>
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-extrabold" style={{ color: C.ink, fontFamily: "'Circular Spotify Text', sans-serif" }}>Calmación</h1>
